...
/** Pros and cons of this implementation of performance testing, and other possible ways to do so:
 *
 */
...
public class TestPerformance {
  ...
  @Test void testLong(){
    System.out.println("On the data type Long");
    msgAll(TestLong.dataset);
    }
  }
